...
// 9
{
 ...
 notes(s,'Table07 and complete Figure06 use exactly the same order: increasing max(sc_FDR, bulk_FDR), with alphabetical pathway-name ties. The maximum is a display ordering key, not a combined FDR. Position and adjacent numbers indicate NES. Blue denotes relapse scRNAseq and orange denotes STAT5B N642H bulk. A separate aligned column shows full-catalog BH FDR and stars: *<0.05, **<0.01, ***<0.001. Stars use unrounded FDR, never nominal P. All40 satisfy FDR<0.05 in both datasets. Bold labels identify hypothesis targets without changing ordering. Layout reference: Reis-de-Oliveira et al., Nature Communications (2024), Figures3B and4D, https://www.nature.com/articles/s41467-024-50875-z . Only the plot layout is adapted; the reference article uses other enrichment statistics.');
}
{
