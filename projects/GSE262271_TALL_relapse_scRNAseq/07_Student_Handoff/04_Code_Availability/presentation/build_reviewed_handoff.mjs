...
// 9
{
 ...
 notes(s,'Table07 and complete Figure06 use exactly the same order: increasing max(sc_FDR, bulk_FDR), with alphabetical pathway-name ties. The maximum is a display ordering key, not a combined FDR. Point position indicates NES. Blue denotes relapse scRNAseq and orange denotes STAT5B N642H bulk. Stars beside each point indicate full-catalog BH FDR: *<0.05, **<0.01, ***<0.001. Stars use unrounded FDR, never nominal P. All40 satisfy FDR<0.05 in both datasets. All pathway labels use the same plain typeface. Layout reference: Reis-de-Oliveira et al., Nature Communications (2024), Figures3B and4D, https://www.nature.com/articles/s41467-024-50875-z . Only the plot layout is adapted; the reference article uses other enrichment statistics.');
}
{
